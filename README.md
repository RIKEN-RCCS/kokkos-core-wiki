...
ドキュメントをビルドするには、最低でも Python 3.12 が必要です。通常はシステムのパッケージマネージャーでインストールできますが、お使いのシステムが Python 3.12 以上をサポートしていない場合は、[pyenv](https://github.com/pyenv/pyenv) を使って簡単にインストールできます。
