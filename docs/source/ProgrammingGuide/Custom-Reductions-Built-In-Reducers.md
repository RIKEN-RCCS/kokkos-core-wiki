...
The following is an example for doing a simple min-reduction, finding the minimal value in a discretization of a parable.以下は、たとえ話の離散化における最小値を求める単純な最小還元を行う例です。
