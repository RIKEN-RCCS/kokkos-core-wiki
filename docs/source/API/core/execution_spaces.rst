...
.. |ExecutionSpaceConceptType| replacement:: :cpp:func:`ExecutionSpace` type

.. _DocExecutionSpaceConcept: #kokkos-executionspaceconcept

.. |DocExecutionSpaceConcept| replacement:: the documentation on the :cpp:func:`ExecutionSpace` concept

.. _Experimental: utilities/experimental.html#experimentalnamespace

.. |Experimental| replacement:: Experimental

.. _KokkosConcepts: KokkosConcepts.html

.. |KokkosConcepts| replacement:: this document

.. _ExecutionSpaceS: #kokkos-executionspaceconcept

.. |ExecutionSpaceS| replacement:: :cpp:func:`ExecutionSpace` s

.. _MemorySpace: memory_spaces.html#kokkos-memoryspaceconcept

.. |MemorySpace| replacement:: :cpp:func:`MemorySpace`

.. _KokkosSpaceAccessibility: SpaceAccessibility.html

.. |KokkosSpaceAccessibility| replacement:: :cpp:func:`Kokkos::SpaceAccessibility`

.. _KokkosTeamPolicy: policies/TeamPolicy.html

.. |KokkosTeamPolicy| replacement:: :cpp:func:`Kokkos::TeamPolicy`

.. _ExecutionSpaceConcept: #kokkos-executionspaceconcept

.. |ExecutionSpaceConcept| replacement:: :cpp:func:`ExecutionSpaceConcept`
...
.. code-block:: cpp
    ...
    パブリック:
        型定義 ExecutionSpaceConcept execution_space;
        型定義 ... memory_space;
        型定義 Device<execution_space, memory_space> device_type;
        型定義 ... scratch_memory_space;
        型定義 ... array_layout;
        型定義 ... size_type;
        ...
        フレンドブール演算子==(const execution_space& lhs, const execution_space& rhs);
    };
