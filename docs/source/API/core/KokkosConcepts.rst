...
Kokkos は、その始まりから本質的にコンセプト主導のデザインを採用してきました。
...
現在の Kokkos |ExecutionSpaceTwo|_ コンセプトの現状は、以下のようなものとなります:
...
``MemorySpace`` の現在のコンセプトは、以下のようなものとなります:
