...
okkos は最新のC++言語標準をサポートしています。 特定の機能は、有効になっている言語標準に応じて、異なるコードパスを使用したり、異なるコンパイラサポートを持つ場合があります。Kokkos がどの言語標準でコンパイルされたかを判別するために公開されています。
...
Tこれらの定義は、 Kokkos がコンパイルされたサードパーティライブラリに関する情報を提供します。
...
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
| ``KOKKOS_ARCH_AMD_GFX1100``       | AMD GPU  7900 XTMI (GPU) 向けに最適化。                                                                |
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
| ``KOKKOS_ARCH_AMD_GFX1103``       | AMD Phoenix APU（GPU）向けに最適化。                                                                   |
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
| ``KOKKOS_ARCH_AMD_GFX1201``       | AMD GPU 9070 XT (GPU) 向けに最適化。                                                                   |
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
| ``KOKKOS_ARCH_AMD_GPU``           | MD GPU　のアーキテクチャフラグの文字列（例：MI250Xアクセラレータをターゲットとする場合　"gfx90A"　）   |
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
...
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
| ``KOKKOS_ARCH_NAVI``              | いずれかの　AMD Navi GPU アーキテクチャが有効化されているかどうかを設定。:sup:` Kokkos 4.0`            |
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
| ``KOKKOS_ARCH_NAVI1030``          | AMD GPU V620/W6800 GFX1030 (GPU) :sup:` Kokkos 4.0以降`向けに最適化。                                  |
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
...
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
| ``KOKKOS_ARCH_ADA89``             | NVIDIA Ada generation CC 8.9 (GPU) 向けに最適化。:sup:`Kokkos 4.1以降`                                 |
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
| ``KOKKOS_ARCH_HOPPER``            | いずれかの NVIDIA Hopper アーキテクチャが有効化されているかどうかを設定。 :sup:`since Kokkos 4.0` 以降 |
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
| ``KOKKOS_ARCH_HOPPER90``          | NVIDIA Hopper generation CC 9.0 (GPU)　向けに最適化。:sup:`Kokkos 4.0以降`                             |
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
| ``KOKKOS_ARCH_BLACKWELL``         | いずれかの NVIDIA Blackwell アーキテクチャが有効化されているかどうかを設定。 :sup:`Kokkos 4.7以降`     |
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
| ``KOKKOS_ARCH_BLACKWELL100``      | NVIDIA Blackwell generation CC 10.0 (GPU) 向けに最適化。:sup:`Kokkos 4.7以降`                          |
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
| ``KOKKOS_ARCH_BLACKWELL120``      | NVIDIA Blackwell generation CC 12.0 (GPU) 向けに最適化。:sup:`Kokkos 4.7以降`                          |
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
