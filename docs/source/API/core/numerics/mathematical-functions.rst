...
* - |exp|_
   ...
   * - |expm1|_
     - :math:`e` を指定された指数でべき乗し、 :math:`1` を引いた値を返す (:math:`e^x-1`)
   * - |log|_
   ...
   * - |log1p|_
     - 1に指定された数を加えたものの (底 :math:`e` の) 自然対数 (:math:`\ln(1+x)`)
...
* - |fpclassify|_ [#since_kokkos_5_1]_
   ...
   * - |isgreater|_ [#since_kokkos_5_1]_
     - 第1の浮動小数点引数が第2の引数より大きいかどうかを確認する
   * - |isgreaterequal|_ [#since_kokkos_5_1]_
     - 第1の浮動小数点引数が第2の引数以上かどうかを確認する
   * - |isless|_ [#since_kokkos_5_1]_
     - 第1の浮動小数点引数が第2の引数より小さいかどうかを確認する
   * - |islessequal|_ [#since_kokkos_5_1]_
     - 第1の浮動小数点引数が第2の引数以下かどうかを確認する
   * - |islessgreater|_ [#since_kokkos_5_1]_
     - 第1の浮動小数点引数が第2の引数より小さいか大きいかを確認する
   * - |isunordered|_ [#since_kokkos_5_1]_
     - 2つの浮動小数点値が順序付け不可能かどうかを確認する
